...
| Refreshing page logs a user out. | 'DEV' setting on Heroku enabled database confusin. Setting removed to allow one sqlite for development and psotgres for production. |
